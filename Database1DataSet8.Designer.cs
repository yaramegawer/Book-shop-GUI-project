...
namespace WindowsFormsApp1 {
    ...
    public partial class Database1DataSet8 : global::System.Data.DataSet {
        ...
        public partial class Table4DataTable : global::System.Data.TypedTableBase<Table4Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public Table4Row AddTable4Row(int Id, string name, double price) {
        ...
        public partial class Table4Row : global::System.Data.DataRow {
            ...
            public double price {
                get {
                    try {
                        return ((double)(this[this.tableTable4.priceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WindowsFormsApp1.Database1DataSet8TableAdapters {
    ...
    public partial class Table4TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table4] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table4] ([Id], [name], [price]) VALUES (@Id, @name, @price);\r\n" +
                "SELECT Id, name, price FROM Table4 WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table4] SET [Id] = @Id, [name] = @name, [price] = @price WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT Id, name, price FROM Table4 WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, price FROM dbo.Table4";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, name, price\r\nFROM   Table4\r\nWHERE (name LIKE @Name + N\'%\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.NChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(Database1DataSet8.Table4DataTable dataTable) {
        ...
        public virtual Database1DataSet8.Table4DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet8.Table4DataTable dataTable = new Database1DataSet8.Table4DataTable();
        ...
        public virtual int search(Database1DataSet8.Table4DataTable dataTable, string Name) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet8.Table4DataTable dataTable) {
        ...
        public virtual int Insert(int Id, string name, global::System.Nullable<double> price) {
        ...
        public virtual int Update(int Id, string name, global::System.Nullable<double> price, int Original_Id, string Original_name, global::System.Nullable<double> Original_price) {
